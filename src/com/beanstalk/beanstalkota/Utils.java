...
public class Utils {
    ...
    public static final String FILES_INFO = "com.beanstalk.beanstalkota.Utils.FILES_INFO";
    ...
    public static boolean isSystemApp(Context context) throws Exception {
        ...
        android.content.pm.PackageInfo info = pm.getPackageInfo("com.beanstalk.beanstalkota",
